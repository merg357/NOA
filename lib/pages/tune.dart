...
import 'package:noa/pages/aria_settings.dart';
            ...
            children: [
              ...
              GestureDetector(
                onTap: () => Navigator.push(
                  context,
                  PageRouteBuilder(
                    pageBuilder: (_, __, ___) => const AriaSettingsPage(),
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text('ARIA Settings', style: textStyleDark),
                      const Icon(Icons.chevron_right, color: colorDark),
                    ],
                  ),
                ),
              ),
